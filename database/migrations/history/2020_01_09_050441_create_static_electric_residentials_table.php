...
class CreateStaticElectricResidentialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('static_electric_residentials', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('static_electric_residentials');
    }
}
