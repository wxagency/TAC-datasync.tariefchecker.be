...
class CreateStaticGasProfessionalsTable extends Migration
{ 
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('static_gas_professionals', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('static_gas_professionals');
    }
}
