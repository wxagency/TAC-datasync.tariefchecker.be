...
class CreateDynamicGasResidentialsTable extends Migration
{
    /** 
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('dynamic_gas_residentials', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dynamic_gas_residentials');
    }
}
