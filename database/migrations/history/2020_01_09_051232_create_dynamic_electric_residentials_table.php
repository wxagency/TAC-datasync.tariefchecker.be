...
class CreateDynamicElectricResidentialsTable extends Migration
{ 
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('dynamic_electric_residentials', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('dynamic_electric_residentials');
    }
}
