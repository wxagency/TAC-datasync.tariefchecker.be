                        ...
                        <div class="portlet-body">
                            ...
                            <form action="{{route('discount.store')}}" method="POST" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('productId') ? ' has-error' : '' }}" id="productid">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('comparisonType') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('channel') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('applicationVContractDuration') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('serviceLevelPayment') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('serviceLevelInvoicing') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('serviceLevelContact') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('minimumSupplyCondition') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('duration') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('applicability') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('valueType') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('value') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('unit') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('applicableForExistingCustomers') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('nameNl') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('descriptionNl') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('nameFr') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group d-none hidden-field {{ $errors->has('descriptionFr') ? ' has-error' : '' }}">
                                ...
                                <div class="form-actions  d-none hidden-field">
                                    <div class="row">
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (len > 0) {
                                    ...
                                    $(".d-none.hidden-field").addClass("show-hidden-fields");
                                    for (var i = 0; i < len; i++) {
