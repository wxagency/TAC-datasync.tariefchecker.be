...
class SupplierData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'supplierdata:store';
    ...
    {
        try {
            $this->alert('Fetching Supplier list from Airtable : ' . Carbon::now());
            $this->_manageSupplier();
    ...
    private function _manageSupplier()
    {
          Supplier::truncate();
