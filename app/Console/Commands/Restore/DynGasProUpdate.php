...
class DynGasProUpdate extends Command
{
    use AirtableTrait;

    const TABLE = 'Dyn data - G PRO';
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'dynamic-gasPro:update';
    ...
    {
        $this->info("---Dynamic gas Professional Restore started---");
        $this->_restore();
        $this->info("---Dynamic gas Professional Restore ended---");
    }
    ...
    private function _restore()
    {
        ...
        $current_data = [];
        $new_data = [];
        $data = DynamicGasProfessional::where('backupdate', $restoreDate)->get()->toArray();
    ...
    private function _getProducts()
    {
        ...
        while (Session::get('p_offset') != 'stop') {
            ...
            $json = $this->get('Stat%20data%20-%20G%20PRO', $query);
