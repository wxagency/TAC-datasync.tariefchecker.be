...
class PackProUpdate extends Command
{
    use AirtableTrait;
    /**
     ...
     * @var string
     */
    protected $signature = 'pack-pro:update';
    ...
    const TABLE = 'Stat data - Packs PRO';
    /**
    ...
    {
        $this->info("---Pack Professional Restore started--");
        $this->_update();
        $this->info("---Pack Professional Restore ended--");
    }
    ...
    public function _update()
    {
        ...
        $currentData = [];
        $newData = [];
        $data = StaticPackProfessional::where('backupdate', $restoreDate)->get()->toArray();
    ...
    function _formatRecord($record, $_id = '')
    {
        ...
        $newData = [
            ...
            'Active'  =>  $this->get_value($record['active']),
            ...
            'check E'  =>  $this->get_value($record['check_elec']),
            'check G'  =>  $this->get_value($record['check_gas']),
        ];
        $result = [
            'fields' =>  $newData,
        ];
