...
class DynElekProUpdate extends Command
{
    use AirtableTrait;

    const TABLE = 'Dyn data - E PRO';
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'dynamic-elekPro:update';
    ...
    {
        $this->info("---Dynamic Electric Professional Restore started---");
        $this->_restore();
        $this->info("---Dynamic Electric Professional Restore ended---");
    }
    ...
    private function _restore()
    {
        ...
        $current_data = [];
        $new_data = [];
        $data = DynamicElectricProfessional::where('backupdate', $restoreDate)->get()->toArray();
    ...
    private function _getProducts()
    {
        ...
        while (Session::get('p_offset') != 'stop') {
            ...
            $json = $this->get('Stat%20data%20-%20E%20PRO', $query);
