...
class staticElectricres extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'staticElectricres:start {table_name}{backupdate}';
    ...
    public function handle()
    {
        ...
        $data=StaticElecticResidential::where('backup_date',$backupdate)->get();
      ...
      if($value->green_percentage!=""){
        ...
        // $query['records'][0]['fields']['PACKS PAR']=date("d/m/Y", strtotime($value->date));
         ...
         try {
                ...
                $request = $client->post('https://api.airtable.com/v0/applSCRl4UvL2haqK/ELEK%20RES', [
                    'headers' => [
    ...
    private function _delete()
    {
       ...
       while(Session::get('offset')!='stop') {
           try {
               ...
               $request = $client->get('https://api.airtable.com/v0/applSCRl4UvL2haqK/ELEK%20RES', [
                   'headers' => [
                       'Accept' => 'application/json',
           ...
           if (isset($json['offset'])) {
             ...
             if(!empty($json['records'])) {
                ...
                $query['records'][0]=$value['id'];
                        $request =$client->delete('https://api.airtable.com/v0/applSCRl4UvL2haqK/ELEK%20RES', [
                                'headers' => [
                                'Accept' => 'application/json',
                                'Content-type' => 'application/json',
                                'Authorization' => 'Bearer keySZo45QUBRPLwjL'
