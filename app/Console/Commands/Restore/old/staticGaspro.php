...
class staticGaspro extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'staticGaspro:start {table_name}{backupdate}';
    ...
    public function handle()
    {
        ...
        $data=StaticGasProfessional::where('backupdate',$backupdate)->get();
     ...
     if($value->fixed_indiable!=""){
        ...
        // $query['records'][0]['fields']['PACKS PRO']=date("d/m/Y", strtotime($value->date));
         ...
         try {
                ...
                $request = $client->post('https://api.airtable.com/v0/applSCRl4UvL2haqK/GAS%20PRO', [
                    'headers' => [
    ...
    private function _delete()
    {
        ...
        while(Session::get('offset')!='stop') {
            try {
                ...
                $request = $client->get('https://api.airtable.com/v0/applSCRl4UvL2haqK/GAS%20PRO', [
                    'headers' => [
                        'Accept' => 'application/json',
            ...
            if(!empty($json['records'])) {
                ...
                $query['records'][0]=$value['id'];
                        $request =$client->delete('https://api.airtable.com/v0/applSCRl4UvL2haqK/GAS%20PRO', [
                                'headers' => [
                                'Accept' => 'application/json',
                                'Content-type' => 'application/json',
                                'Authorization' => 'Bearer keySZo45QUBRPLwjL'
