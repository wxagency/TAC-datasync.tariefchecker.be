...
class dynamicElectricPro extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'dynamicElectricpro:start {table_name}{backupdate}';
    ...
    public function handle()
    {
        ...
        $data=DynamicElectricProfessional::where('backupdate',$backupdate)->get();
        ...
        $pro=StaticElectricProfessional::where('product_id',$value->product_id)->first();
        ...
        $query['records'][0]['fields']['Valid till']=date("d/m/Y", strtotime($value->valid_till));
         ...
         try {
                ...
                $request = $client->post('https://api.airtable.com/v0/applSCRl4UvL2haqK/Dyn%20data%20-%20E%20PRO', [
                    'headers' => [
          ...
          while(Session::get('offset')!='stop') {
              ...
              if (isset($json['offset'])) {
                ...
                $query['records'][0]=$value['id'];
                        $request =$client->delete('https://api.airtable.com/v0/applSCRl4UvL2haqK/Dyn%20data%20-%20E%20PRO', [
                                'headers' => [
                                'Accept' => 'application/json',
                                'Content-type' => 'application/json',
                                'Authorization' => 'Bearer keySZo45QUBRPLwjL'
